...
if __name__ == '__main__':
    ...
    train_layer = Layer()
    train_layer.load_input('psi/static/MNIST_ORG/train-images.idx3-ubyte', 5000)
    train_layer.X = train_layer.X / 255

    train_layer.load_label('psi/static/MNIST_ORG/train-labels.idx1-ubyte', 5000)
    ...
    test_layer = Layer()
    test_layer.load_input('psi/static/MNIST_ORG/t10k-images.idx3-ubyte', 1000)
    test_layer.X = test_layer.X / 255

    test_layer.load_label('psi/static/MNIST_ORG/t10k-labels.idx1-ubyte', 1000)
    ...
    while True:  
        ...
        gd2.insert_activation_function(gd.tanh, 0)
        gd2.insert_activation_function(gd.softmax, 1)
